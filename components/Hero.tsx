        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-[#0B2545] rounded-lg p-8 text-white text-center">
            ...
            <p className="text-white/70 text-sm italic mb-2">
              &ldquo;The knowledge precedes speech and action.&rdquo;
            </p>
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {disciplines.map((d, i) => (
              <div
                key={i}
                className="border border-[#C8A44A]/20 rounded-md p-7 text-center hover:-translate-y-1 hover:shadow-lg transition-all duration-200 bg-[#FAF7EF] cursor-pointer"
              >
